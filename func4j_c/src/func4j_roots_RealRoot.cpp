/*
 * func4j_roots_RealRoot.cpp
 *
 *  Created on: Jan 9, 2021
 *      Author: meisam
 */

#include "../headers/func4j_roots_RealRoot.h"
...
JNIEXPORT void JNICALL Java_func4j_roots_RealRoot_initFieldIDs
  (JNIEnv *env, jclass RealRoot) {
	realroot1d_func_class = env -> FindClass("func4j/roots/RealRootFunction") ;
	realroot1d_derivfunc_class = env -> FindClass("func4j/roots/RealRootDerivFunction") ;
	...
	realroot1d_func_id = env -> GetFieldID(RealRoot, "func", "Lfunc4j/roots/RealRootFunction;") ;
	realroot1d_derivfunc_id = env -> GetFieldID(RealRoot, "derivFunc", "Lfunc4j/roots/RealRootDerivFunction;") ;
