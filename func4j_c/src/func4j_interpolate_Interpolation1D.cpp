/*
 * func4j_interpolate_Interpolation1D.cpp
 *
 *  Created on: Jan 18, 2021
 *      Author: meisam
 */

#include "../headers/func4j_interpolate_Interpolation1D.h"
...
namespace {
	...
	public:
		Interpolator1D(JNIEnv *env, jobject Interpolation1D) {
			...
			if(type == func4j_interpolate_Interpolation1D_LINEAR)
				t_interp1d = gsl_interp_linear ;
			else if(type == func4j_interpolate_Interpolation1D_POLYNOMIAL)
				t_interp1d = gsl_interp_polynomial ;
			else if(type == func4j_interpolate_Interpolation1D_CUBIC_SPLINE)
				t_interp1d = gsl_interp_cspline ;
			else if(type == func4j_interpolate_Interpolation1D_CUBIC_SPLINE_PERIODIC)
				t_interp1d = gsl_interp_cspline_periodic ;
			else if(type == func4j_interpolate_Interpolation1D_AKIMA)
				t_interp1d = gsl_interp_akima ;
			else if(type == func4j_interpolate_Interpolation1D_AKIMA_PERIODIC)
