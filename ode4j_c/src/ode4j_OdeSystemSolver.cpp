/*
 * ode4j_OdeSystemSolver.cpp
 *
 *  Created on: Jan 22, 2021
 *      Author: meisam
 */

#include "../headers/ode4j_OdeSystemSolver.h"
...
JNIEXPORT void JNICALL Java_ode4j_OdeSystemSolver_initIDs
  (JNIEnv *env, jclass OdeSystemSolver) {
	odesys_derivnfunc_class = env -> FindClass("ode4j/DerivnFunction") ;
	odesys_derivnfunc_value_id = env -> GetMethodID(odesys_derivnfunc_class, "values", "(D[D)[D") ;
	odesys_derivnfunc_id = env -> GetFieldID(OdeSystemSolver, "func", "Lode4j/DerivnFunction;") ;

	odesys_derivnfunc_df_dx_class = env -> FindClass("ode4j/DerivnFunction") ;
	odesys_derivnfunc_df_dx_value_id = env -> GetMethodID(odesys_derivnfunc_df_dx_class, "values", "(D[D)[D") ;
	odesys_derivnfunc_df_dx_id = env -> GetFieldID(OdeSystemSolver, "df_dx", "Lode4j/DerivnFunction;") ;

	odesys_derivnfunc_df_dy_class = env -> FindClass("ode4j/DerivnJacobian") ;
	odesys_derivnfunc_df_dy_value_id = env -> GetMethodID(odesys_derivnfunc_df_dy_class, "values", "(D[D)[[D") ;
	odesys_derivnfunc_df_dy_id = env -> GetFieldID(OdeSystemSolver, "df_dy", "Lode4j/DerivnJacobian;") ;
