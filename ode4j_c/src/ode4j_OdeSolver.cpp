...
#include "../headers/ode4j_OdeSolver.h"
...
/*
 * Class:     ode4j_OdeSolver
 * Method:    initIDs
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_ode4j_OdeSolver_initIDs
  (JNIEnv *env, jclass OdeSolver) {
	ode_derivfunc_class = env -> FindClass("ode4j/DerivFunction") ;
	ode_derivfunc_value_id = env -> GetMethodID(ode_derivfunc_class, "value", "(DD)D") ;
	ode_derivfunc_id = env -> GetFieldID(OdeSolver, "func", "Lode4j/DerivFunction;") ;

	ode_derivfunc_df_dx_class = env -> FindClass("ode4j/DerivFunction") ;
	ode_derivfunc_df_dx_value_id = env -> GetMethodID(ode_derivfunc_df_dx_class, "value", "(DD)D") ;
	ode_derivfunc_df_dx_id = env -> GetFieldID(OdeSolver, "df_dx", "Lode4j/DerivFunction;") ;

	ode_derivfunc_df_dy_class = env -> FindClass("ode4j/DerivFunction") ;
	ode_derivfunc_df_dy_value_id = env -> GetMethodID(ode_derivfunc_df_dy_class, "value", "(DD)D") ;
	ode_derivfunc_df_dy_id = env -> GetFieldID(OdeSolver, "df_dy", "Lode4j/DerivFunction;") ;
 ...
 * Signature: (D)D
 */
JNIEXPORT jdouble JNICALL Java_ode4j_OdeSolver_rk2__D
 ...
 * Signature: ([D)[D
 */
JNIEXPORT jdoubleArray JNICALL Java_ode4j_OdeSolver_rk2___3D
 ...
 * Signature: (D)D
 */
JNIEXPORT jdouble JNICALL Java_ode4j_OdeSolver_rk4__D
  (JNIEnv *env, jobject OdeSolver, jdouble x) {
	jdouble epsabs = env -> GetDoubleField(OdeSolver, ode_abserr_id) ;
	jdouble epsrel = env -> GetDoubleField(OdeSolver, ode_relerr_id) ;
	jdouble min_step_size = env -> GetDoubleField(OdeSolver, ode_min_step_size_id) ;
 ...
 * Signature: ([D)[D
 */
JNIEXPORT jdoubleArray JNICALL Java_ode4j_OdeSolver_rk4___3D
  (JNIEnv *env, jobject OdeSolver, jdoubleArray jx) {
	jdouble epsabs = env -> GetDoubleField(OdeSolver, ode_abserr_id) ;
	jdouble epsrel = env -> GetDoubleField(OdeSolver, ode_relerr_id) ;
	jdouble min_step_size = env -> GetDoubleField(OdeSolver, ode_min_step_size_id) ;
 ...
 * Signature: (D)D
 */
JNIEXPORT jdouble JNICALL Java_ode4j_OdeSolver_rkf45__D
  (JNIEnv *env, jobject OdeSolver, jdouble x) {
	jdouble epsabs = env -> GetDoubleField(OdeSolver, ode_abserr_id) ;
	jdouble epsrel = env -> GetDoubleField(OdeSolver, ode_relerr_id) ;
	jdouble min_step_size = env -> GetDoubleField(OdeSolver, ode_min_step_size_id) ;
 ...
 * Signature: ([D)[D
 */
JNIEXPORT jdoubleArray JNICALL Java_ode4j_OdeSolver_rkf45___3D
  (JNIEnv *env, jobject OdeSolver, jdoubleArray jx) {
	jdouble epsabs = env -> GetDoubleField(OdeSolver, ode_abserr_id) ;
	jdouble epsrel = env -> GetDoubleField(OdeSolver, ode_relerr_id) ;
	jdouble min_step_size = env -> GetDoubleField(OdeSolver, ode_min_step_size_id) ;
 ...
 * Signature: (D)D
 */
JNIEXPORT jdouble JNICALL Java_ode4j_OdeSolver_rkck__D
  (JNIEnv *env, jobject OdeSolver, jdouble x) {
	jdouble epsabs = env -> GetDoubleField(OdeSolver, ode_abserr_id) ;
	jdouble epsrel = env -> GetDoubleField(OdeSolver, ode_relerr_id) ;
	jdouble min_step_size = env -> GetDoubleField(OdeSolver, ode_min_step_size_id) ;
 ...
 * Signature: ([D)[D
 */
JNIEXPORT jdoubleArray JNICALL Java_ode4j_OdeSolver_rkck___3D
  (JNIEnv *env, jobject OdeSolver, jdoubleArray jx) {
	jdouble epsabs = env -> GetDoubleField(OdeSolver, ode_abserr_id) ;
	jdouble epsrel = env -> GetDoubleField(OdeSolver, ode_relerr_id) ;
	jdouble min_step_size = env -> GetDoubleField(OdeSolver, ode_min_step_size_id) ;
 ...
 * Signature: (D)D
 */
JNIEXPORT jdouble JNICALL Java_ode4j_OdeSolver_rk8pd__D
  (JNIEnv *env, jobject OdeSolver, jdouble x) {
	jdouble epsabs = env -> GetDoubleField(OdeSolver, ode_abserr_id) ;
	jdouble epsrel = env -> GetDoubleField(OdeSolver, ode_relerr_id) ;
	jdouble min_step_size = env -> GetDoubleField(OdeSolver, ode_min_step_size_id) ;
 ...
 * Signature: ([D)[D
 */
JNIEXPORT jdoubleArray JNICALL Java_ode4j_OdeSolver_rk8pd___3D
  (JNIEnv *env, jobject OdeSolver, jdoubleArray jx) {
	jdouble epsabs = env -> GetDoubleField(OdeSolver, ode_abserr_id) ;
	jdouble epsrel = env -> GetDoubleField(OdeSolver, ode_relerr_id) ;
	jdouble min_step_size = env -> GetDoubleField(OdeSolver, ode_min_step_size_id) ;
 ...
 * Signature: (D)D
 */
JNIEXPORT jdouble JNICALL Java_ode4j_OdeSolver_rk1imp__D
  (JNIEnv *env, jobject OdeSolver, jdouble x) {
	jdouble epsabs = env -> GetDoubleField(OdeSolver, ode_abserr_id) ;
	jdouble epsrel = env -> GetDoubleField(OdeSolver, ode_relerr_id) ;
	jdouble min_step_size = env -> GetDoubleField(OdeSolver, ode_min_step_size_id) ;
 ...
 * Signature: ([D)[D
 */
JNIEXPORT jdoubleArray JNICALL Java_ode4j_OdeSolver_rk1imp___3D
  (JNIEnv *env, jobject OdeSolver, jdoubleArray jx) {
	jdouble epsabs = env -> GetDoubleField(OdeSolver, ode_abserr_id) ;
	jdouble epsrel = env -> GetDoubleField(OdeSolver, ode_relerr_id) ;
	jdouble min_step_size = env -> GetDoubleField(OdeSolver, ode_min_step_size_id) ;
 ...
 * Signature: (D)D
 */
JNIEXPORT jdouble JNICALL Java_ode4j_OdeSolver_rk2imp__D
  (JNIEnv *env, jobject OdeSolver, jdouble x) {
	jdouble epsabs = env -> GetDoubleField(OdeSolver, ode_abserr_id) ;
	jdouble epsrel = env -> GetDoubleField(OdeSolver, ode_relerr_id) ;
	jdouble min_step_size = env -> GetDoubleField(OdeSolver, ode_min_step_size_id) ;
 ...
 * Signature: ([D)[D
 */
JNIEXPORT jdoubleArray JNICALL Java_ode4j_OdeSolver_rk2imp___3D
  (JNIEnv *env, jobject OdeSolver, jdoubleArray jx) {
	jdouble epsabs = env -> GetDoubleField(OdeSolver, ode_abserr_id) ;
	jdouble epsrel = env -> GetDoubleField(OdeSolver, ode_relerr_id) ;
	jdouble min_step_size = env -> GetDoubleField(OdeSolver, ode_min_step_size_id) ;
 ...
 * Signature: (D)D
 */
JNIEXPORT jdouble JNICALL Java_ode4j_OdeSolver_rk4imp__D
  (JNIEnv *env, jobject OdeSolver, jdouble x) {
	jdouble epsabs = env -> GetDoubleField(OdeSolver, ode_abserr_id) ;
	jdouble epsrel = env -> GetDoubleField(OdeSolver, ode_relerr_id) ;
	jdouble min_step_size = env -> GetDoubleField(OdeSolver, ode_min_step_size_id) ;
 ...
 * Signature: ([D)[D
 */
JNIEXPORT jdoubleArray JNICALL Java_ode4j_OdeSolver_rk4imp___3D
  (JNIEnv *env, jobject OdeSolver, jdoubleArray jx) {
	jdouble epsabs = env -> GetDoubleField(OdeSolver, ode_abserr_id) ;
	jdouble epsrel = env -> GetDoubleField(OdeSolver, ode_relerr_id) ;
	jdouble min_step_size = env -> GetDoubleField(OdeSolver, ode_min_step_size_id) ;
 ...
 * Signature: (D)D
 */
JNIEXPORT jdouble JNICALL Java_ode4j_OdeSolver_bsimp__D
  (JNIEnv *env, jobject OdeSolver, jdouble x) {
	jdouble epsabs = env -> GetDoubleField(OdeSolver, ode_abserr_id) ;
	jdouble epsrel = env -> GetDoubleField(OdeSolver, ode_relerr_id) ;
	jdouble min_step_size = env -> GetDoubleField(OdeSolver, ode_min_step_size_id) ;
 ...
 * Signature: ([D)[D
 */
JNIEXPORT jdoubleArray JNICALL Java_ode4j_OdeSolver_bsimp___3D
  (JNIEnv *env, jobject OdeSolver, jdoubleArray jx) {
	jdouble epsabs = env -> GetDoubleField(OdeSolver, ode_abserr_id) ;
	jdouble epsrel = env -> GetDoubleField(OdeSolver, ode_relerr_id) ;
	jdouble min_step_size = env -> GetDoubleField(OdeSolver, ode_min_step_size_id) ;
 ...
 * Signature: (D)D
 */
JNIEXPORT jdouble JNICALL Java_ode4j_OdeSolver_msadams__D
  (JNIEnv *env, jobject OdeSolver, jdouble x) {
	jdouble epsabs = env -> GetDoubleField(OdeSolver, ode_abserr_id) ;
	jdouble epsrel = env -> GetDoubleField(OdeSolver, ode_relerr_id) ;
	jdouble min_step_size = env -> GetDoubleField(OdeSolver, ode_min_step_size_id) ;
 ...
 * Signature: ([D)[D
 */
JNIEXPORT jdoubleArray JNICALL Java_ode4j_OdeSolver_msadams___3D
  (JNIEnv *env, jobject OdeSolver, jdoubleArray jx) {
	jdouble epsabs = env -> GetDoubleField(OdeSolver, ode_abserr_id) ;
	jdouble epsrel = env -> GetDoubleField(OdeSolver, ode_relerr_id) ;
	jdouble min_step_size = env -> GetDoubleField(OdeSolver, ode_min_step_size_id) ;
 ...
 * Signature: (D)D
 */
JNIEXPORT jdouble JNICALL Java_ode4j_OdeSolver_msbdf__D
  (JNIEnv *env, jobject OdeSolver, jdouble x) {
	jdouble epsabs = env -> GetDoubleField(OdeSolver, ode_abserr_id) ;
	jdouble epsrel = env -> GetDoubleField(OdeSolver, ode_relerr_id) ;
	jdouble min_step_size = env -> GetDoubleField(OdeSolver, ode_min_step_size_id) ;
 ...
 * Signature: ([D)[D
 */
JNIEXPORT jdoubleArray JNICALL Java_ode4j_OdeSolver_msbdf___3D
  (JNIEnv *env, jobject OdeSolver, jdoubleArray jx) {
	jdouble epsabs = env -> GetDoubleField(OdeSolver, ode_abserr_id) ;
	jdouble epsrel = env -> GetDoubleField(OdeSolver, ode_relerr_id) ;
	jdouble min_step_size = env -> GetDoubleField(OdeSolver, ode_min_step_size_id) ;
