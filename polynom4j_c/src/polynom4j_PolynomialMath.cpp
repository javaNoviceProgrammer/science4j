/*
 * polynom4j_PolynomialMath.cpp
 *
 *  Created on: Mar 6, 2021
 *      Author: meisam
 */

#include "../headers/polynom4j_PolynomialMath.h"
...
/*
 * Class:     polynom4j_PolynomialMath
 * Method:    eval
 * Signature: ([DD)D
 */
JNIEXPORT jdouble JNICALL Java_polynom4j_PolynomialMath_eval___3DD
 ...
 * Signature: ([DDD)[D
 */
JNIEXPORT jdoubleArray JNICALL Java_polynom4j_PolynomialMath_eval___3DDD
 ...
 * Signature: ([D[DDD)[D
 */
JNIEXPORT jdoubleArray JNICALL Java_polynom4j_PolynomialMath_eval___3D_3DDD
 ...
 * Signature: ([DID)[D
 */
JNIEXPORT jdoubleArray JNICALL Java_polynom4j_PolynomialMath_evalDerivs
 ...
 * Signature: (DDD)[D
 */
JNIEXPORT jdoubleArray JNICALL Java_polynom4j_PolynomialMath_solveQuadraticRealRoots
 ...
 * Signature: (DDD)[D
 */
JNIEXPORT jdoubleArray JNICALL Java_polynom4j_PolynomialMath_solveQuadraticComplexRoots
  (JNIEnv *env, jclass PolynomialMath, jdouble a, jdouble b, jdouble c) {
 ...
 * Signature: (DDD)[D
 */
JNIEXPORT jdoubleArray JNICALL Java_polynom4j_PolynomialMath_solveCubicRealRoots
  (JNIEnv *env, jclass PolynomialMath, jdouble a, jdouble b, jdouble c) {
	jdouble x0 = GSL_NAN ;
	jdouble x1 = GSL_NAN ;
	jdouble x2 = GSL_NAN ;
 ...
 * Signature: (DDD)[D
 */
JNIEXPORT jdoubleArray JNICALL Java_polynom4j_PolynomialMath_solveCubicComplexRoots
  (JNIEnv *env, jclass PolynomialMath, jdouble a, jdouble b, jdouble c) {
	gsl_complex z0 {{GSL_NAN, GSL_NAN}} ;
	gsl_complex z1 {{GSL_NAN, GSL_NAN}} ;
 ...
 * Signature: ([D)[D
 */
JNIEXPORT jdoubleArray JNICALL Java_polynom4j_PolynomialMath_solvePolynomialComplexRoots
 ...
 * Signature: ([D[D)[D
 */
JNIEXPORT jdoubleArray JNICALL Java_polynom4j_PolynomialMath_plus___3D_3D
 ...
 * Signature: ([D[D)[D
 */
JNIEXPORT jdoubleArray JNICALL Java_polynom4j_PolynomialMath_minus___3D_3D
  (JNIEnv *env, jclass PolynomialMath, jdoubleArray coeffs1, jdoubleArray coeffs2) {
	jint len_coeffs1 = env -> GetArrayLength(coeffs1) ;
	jdouble *coeffs1_array = new jdouble[len_coeffs1] ;
	env -> GetDoubleArrayRegion(coeffs1, 0, len_coeffs1, coeffs1_array) ;
 ...
 * Signature: ([D[D)[D
 */
JNIEXPORT jdoubleArray JNICALL Java_polynom4j_PolynomialMath_times___3D_3D
  (JNIEnv *env, jclass PolynomialMath, jdoubleArray coeffs1, jdoubleArray coeffs2) {
	jint len_coeffs1 = env -> GetArrayLength(coeffs1) ;
	jdouble *coeffs1_array = new jdouble[len_coeffs1] ;
	env -> GetDoubleArrayRegion(coeffs1, 0, len_coeffs1, coeffs1_array) ;
 ...
 * Signature: ([D[D)[D
 */
JNIEXPORT jdoubleArray JNICALL Java_polynom4j_PolynomialMath_compose
 ...
 * Signature: ([DD)[D
 */
JNIEXPORT jdoubleArray JNICALL Java_polynom4j_PolynomialMath_plus___3DD
 ...
 * Signature: ([DD)[D
 */
JNIEXPORT jdoubleArray JNICALL Java_polynom4j_PolynomialMath_minus___3DD
  (JNIEnv *env, jclass PolynomialMath, jdoubleArray coeffs, jdouble a) {
	jint len_coeffs = env -> GetArrayLength(coeffs) ;
	jdouble *coeffs_array = new jdouble[len_coeffs] ;
	env -> GetDoubleArrayRegion(coeffs, 0, len_coeffs, coeffs_array) ;
 ...
 * Signature: ([DD)[D
 */
JNIEXPORT jdoubleArray JNICALL Java_polynom4j_PolynomialMath_times___3DD
  (JNIEnv *env, jclass PolynomialMath, jdoubleArray coeffs, jdouble a) {
	jint len_coeffs = env -> GetArrayLength(coeffs) ;
	jdouble *coeffs_array = new jdouble[len_coeffs] ;
	env -> GetDoubleArrayRegion(coeffs, 0, len_coeffs, coeffs_array) ;
 ...
 * Signature: ([DD)[D
 */
JNIEXPORT jdoubleArray JNICALL Java_polynom4j_PolynomialMath_divides
  (JNIEnv *env, jclass PolynomialMath, jdoubleArray coeffs, jdouble a) {
	jint len_coeffs = env -> GetArrayLength(coeffs) ;
	jdouble *coeffs_array = new jdouble[len_coeffs] ;
	env -> GetDoubleArrayRegion(coeffs, 0, len_coeffs, coeffs_array) ;
 ...
 * Signature: ([D)[D
 */
JNIEXPORT jdoubleArray JNICALL Java_polynom4j_PolynomialMath_reduce
 ...
 * Signature: ([D[D)[D
 */
JNIEXPORT jdoubleArray JNICALL Java_polynom4j_PolynomialMath_ofRoots
  (JNIEnv *, jclass, jdoubleArray, jdoubleArray);
 ...
 * Signature: ([DI)[D
 */
JNIEXPORT jdoubleArray JNICALL Java_polynom4j_PolynomialMath_pow
 ...
 * Signature: ([D)[D
 */
JNIEXPORT jdoubleArray JNICALL Java_polynom4j_PolynomialMath_diff___3D
  (JNIEnv *env, jclass PolynomialMath, jdoubleArray coeffs) {
	jint len_coeffs = env -> GetArrayLength(coeffs) ;
	jdouble *coeffs_array = new jdouble[len_coeffs] ;
	env -> GetDoubleArrayRegion(coeffs, 0, len_coeffs, coeffs_array) ;
 ...
 * Signature: ([DI)[D
 */
JNIEXPORT jdoubleArray JNICALL Java_polynom4j_PolynomialMath_diff___3DI
 ...
 * Signature: ([D)[D
 */
JNIEXPORT jdoubleArray JNICALL Java_polynom4j_PolynomialMath_integrate___3D
  (JNIEnv *env, jclass PolynomialMath, jdoubleArray coeffs) {
	jint len_coeffs = env -> GetArrayLength(coeffs) ;
	jdouble *coeffs_array = new jdouble[len_coeffs] ;
	env -> GetDoubleArrayRegion(coeffs, 0, len_coeffs, coeffs_array) ;
 ...
 * Signature: ([DI)[D
 */
JNIEXPORT jdoubleArray JNICALL Java_polynom4j_PolynomialMath_integrate___3DI
 ...
 * Signature: ([DDD)D
 */
JNIEXPORT jdouble JNICALL Java_polynom4j_PolynomialMath_integrate___3DDD
