...
public class XYZScatterPlot {
	...
	// data
	ArrayList<XYZScatterSeries> xyzSeriesCollection ;
	int count = 1 ;
	static int id = 0 ;
	// header
	...
	public XYZScatterPlot(String title) {
		this.title = title ;
		xyzSeriesCollection = new ArrayList<>() ;
	}

	public XYZScatterPlot() {
		this(null) ;
	}

	public XYZScatterSeries plot(double[] x, double[] y, double[] z, String color, String marker, int markerSize, String linestyle, int linewidth, String label) {
	...
	public XYZScatterSeries plot(double[] x, double[] y, double[] z) {
	...
	public XYZScatterSeries semilogx(double[] x, double[] y, double[] z, String color, String marker, int markerSize, String linestyle, int linewidth, String label) {
		XYZScatterSeries series = new XYZScatterSeries(x, y, z, "x"+count, "y"+count, "z"+count, color, marker, markerSize, linestyle, linewidth, label) ;
		series.semilogx() ;
		xyzSeriesCollection.add(series) ;
		++count ;
