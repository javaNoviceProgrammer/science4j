...
public class PolynomialMath {
	 ...
	 * @return {@code double[]} : array (re,im) representation of a complex number
	 */
	 ...
	 *
	 * @param coeffsReal : array of real part of complex coefficients
	 * @param coeffsImag : array of imaginary part of complex coefficients
	 * @param re : real part of complex value
	 * @param im : imaginary part of complex value
	 * @return {@code double[]} : array (re,im) representation of a complex number
	 */
	 ...
	 *
	 * @param coeffs : coefficients of the real polynomial
	 * @param n : order of derivatives
	 * @param x : point at which polynomial and derivatives are evaluated
	 * @return {@code double[]} : array of numerical value of derivatives
	 */
	 ...
	 * @return {@code double[]} : array of two roots (root1, root2)
	 */
	 ...
	 *
	 * @param a : coefficient of z^2
	 * @param b : coefficient of z^1
	 * @param c : coefficient of z^0
	 * @return {@code double[]} : array of two roots (re1,im1, re2,im2)
	 */
	 ...
	 * @param b : coefficient of x^1
	 * @param c : coefficient of x^0
	 * @return {@code double[]} : array of three real roots (root1, root2, root3)
	 */
	 ...
	 * @param b : coefficient of z^1
	 * @param c : coefficient of z^0
	 * @return {@code double[]} : array of three complex roots (re1,im1, re2,im2, re3,im3)
	 */
	 ...
	 *
	 * @param coeffs : coefficients of the real polynomial (a_0, a_1, ..., a_{n-1})
	 * @return {@code double[]} : array of n=deg(P(x)) complex roots (re1,im1, re2,im2, ..., reN,imN)
	 */
